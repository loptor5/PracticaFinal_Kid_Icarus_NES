var game = function ()
{
  ...
  Q.Sprite.extend("Pit",
  {
    ...
    step: function (dt)
    {
      ...
      if(this.p.timeDamage == 15) this.p.timeDamage = 0;
    ...
    hit: function (collision)
    {
      if (this.p.alive)
      {
	      ...
	      {
          if(this.p.timeDamage == 0 && collision.obj.p.live > 0)
          {
  ...
  Q.animations("pit_anim",
  {
    ...
    damage_right: { frames: [5, 1, 5, 1], flip: false, rate: 1 / 8, loop: true },
    damage_left: { frames: [5, 1, 5, 1], flip: "x", rate: 1 / 8, loop: true }
  });
  //----------------------------------------------------------------------//
  ...
  Q.Sprite.extend("Viperix",
  {
    ...
    killed: function (collision)
    {
      if (collision.obj.isA("Arrow") || collision.obj.isA("ArrowUp"))
      {
        ...
        if (this.p.live <= 0)
        {
          Q.audio.play("Muerte_Serpiente.mp3", { loop: false }); // Reproduce la musica de muerte de viperix
 ...
 //-----------------------------------------------------------------------//
  ...
  Q.scene("endGame", function(stage)
  {
    ...
    const label = container.insert(new Q.UI.Text(
    {
      color: "#FFFFFF",
      x: 10,
      y: -10 - button.p.h,
