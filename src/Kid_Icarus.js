var game = function(){
  ...
  */
  ...
  Q.loadTMX("Level11.tmx , mario_small.json, mario_small.png, goomba.json, goomba.png, bloopa.json, bloopa.png, princess.png, mainTitle.png, coin.png, coin.json", function() {
